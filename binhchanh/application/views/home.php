...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="http://localhost/mycode/binhchanh/public/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="http://localhost/mycode/binhchanh/public/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="http://localhost/mycode/binhchanh/public/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="http://localhost/mycode/binhchanh/public/js/plugins/plugins.js"></script>
    <script src="http://localhost/mycode/binhchanh/public/js/plugins/audioplayer.js"></script>
    <!-- Active js -->
    <script src="http://localhost/mycode/binhchanh/public/js/active.js"></script>
</body>
