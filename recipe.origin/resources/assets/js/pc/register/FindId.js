                ...
                <div className="container">
                    <div className="block-gird-item">
                        <div className="toobar">
                            <strong className="title pull-left">아이디 / 비밀번호 찾기 </strong>
                        </div>
                        <div className="block-myform block-login">
                        {this.renderErrors()}
                        {this.renderMessage()}
                        <div className="block-content">
                            ...
                            <div className="tab-content find">
                                <div role="tabpanel" className="tab-pane active" id="tab1">
                                    <div className="text-center">
                                        <label className="radio" style={{display: "none"}}>
                                            <input name="auth_type" id="optionsRadios1" defaultValue="phone" onChange={ e => this.onChange({ name:e.target.name, value:e.target.value}) } type="radio" style={{display: "none"}} disabled />
                                            <span>핸드폰 정보로 찾기</span>
                                        </label>
                                        <label className="radio">
                                            <input name="auth_type" id="optionsRadios2" defaultValue="email" onChange={ e => this.onChange({ name:e.target.name, value:e.target.value}) } defaultChecked type="radio" />
                                    ...
                                    <Phones onChange={this.onChange} style={{display:'none'}} />
                                    {/* email find */}
                                    <div className="" >
                                ...
                                <div role="tabpanel" className="tab-pane find_pass" id="tab2">
                                    <div className="text-center">
                                        <label className="radio" style={{display: "none"}}>
                                            <input name="auth_type2" id="optionsRadios1" defaultValue="phone" onChange={ e => this.onChangePass({ name:"auth_type", value:e.target.value}) } type="radio" style={{display: "none"}} disabled />
                                            <span>핸드폰 정보로 찾기</span>
                                        </label>
                                        <label className="radio">
