    ...
    render() {
        ...
        return (
            ...
            <div className="page-title">
			  ...
			  <select className="form-control _md pull-right" style={{width:'30%'}} name="sort" onChange={(e) => this.onChange({ name: e.target.name, value: e.target.value })} >
			...
			{events.map((event,index) => {
               ...
               return <div key={`event-${index}`} className="item-event">
                <div className="photo">
