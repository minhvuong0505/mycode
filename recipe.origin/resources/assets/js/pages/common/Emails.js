        ...
        return (
            <div>
                <div className="row">
                    ...
                    <div id="div_input_email_a" className="col-xs-1" style={{textAlign:"center", display: "none"}}><span className="or">@</span></div>
                    ...
                    <div id="div_input_email_select" className="col-xs-6">
                        <div className="form-group">
                        <select className="form-control" value={this.props.email_host} name="email_host"  onChange={ (e) => this.props.onChange({ name:e.target.name, value:e.target.value}) } {..._disabled} >
