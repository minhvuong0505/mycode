...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{env('CDN_URL')}}/default/css/style.css?v={{ rand(1000, 50000000) }}">
    <script>
...
<body>
    ...
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/jquery.min.js"></script>
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/jquery.fancybox.min.js"></script>
    <script type="text/javascript" src="https://developers.kakao.com/sdk/js/kakao.min.js"></script>
    <script type="text/javascript" src="https://apis.google.com/js/api:client.js"></script>
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/moment-with-locales.js"></script>
    <script type="text/javascript" src="{{env('CDN_URL')}}/default/js/main.js"></script>
