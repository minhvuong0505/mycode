...
arm_L = document.querySelector('.arm_L'),
arm_R = document.querySelector('.arm_R'),
armhandL = document.querySelector('.armhandL'),
armhandR = document.querySelector('.armhandR'),
eyeL = document.querySelector('.eyeL'), 
eyeR = document.querySelector('.eyeR'), 
nose = document.querySelector('.nose'), 
smallNose = document.querySelector('.smallNose'),
...
facePath = document.querySelector('.facePath'),
facePathOutline = document.querySelector('.facePathOutline'),
facePathTemplate = document.querySelector('.facePath_template'),
facePathOutlineTemplate = document.querySelector('.facePathOutline_template'),
faceFocus = document.querySelector('.faceFocus'),
faceFocusOutline = document.querySelector('.faceFocusOutline'),
cheekL = document.querySelector('.cheekL'),
cheekR = document.querySelector('.cheekR'),
philtrum = document.querySelector('.philtrum'),
philtrum2 = document.querySelector('.philtrum2'),
// eyebrow = document.querySelector('.eyebrow'), 
outerEarL = document.querySelector('.earL'), 
outerEarR = document.querySelector('.earR'), 
...
function calculateFaceMove(e) {
	...
	if(email.scrollWidth <= emailScrollMax) {
		...
		eyeLAngle = getAngle(eyeLCoords.x, eyeLCoords.y, emailCoords.x + caretCoords.x, emailCoords.y + 15);
		eyeRAngle = getAngle(eyeRCoords.x, eyeRCoords.y, emailCoords.x + caretCoords.x, emailCoords.y + 15);
...
function resetFace() {
	...
	// TweenMax.to([cheekL, cheekR], 1, {x: 0, y: 0, ease: Expo.easeOut});
	...
	// TweenMax.to(facePath, 1, {morphSVG: facePathTemplate, shapeIndex: 8, ease: Expo.easeOut});
	// TweenMax.to(facePathOutline, 1, {morphSVG: facePathOutlineTemplate, shapeIndex: 8, ease: Expo.easeOut});
	// TweenMax.to([outerEarL, outerEarR], 1, {x: 0, y: 0, scaleY: 1, ease: Expo.easeOut});
	// TweenMax.to(philtrum, 0.2, { scaleY: 1, ease: Expo.easeOut});
	// TweenMax.set(mouth, {visibility: "visible"});
	// TweenMax.to(smallNose, 1, {scaleX: 1, scaleY: 1, transformOrigin: "center center",  ease: Expo.easeOut});
}
